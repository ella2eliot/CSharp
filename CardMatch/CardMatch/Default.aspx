...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<hr />
	<div class="row">
		<div id="countUp" class="col-xs-12">
			<label>時間：</label>
		...
		<div id="countDown" class="col-xs-12">
			<label>倒數時間：</label>
			<span>00:</span><span id="time" class="time">00:00.00</span>
		</div>
	</div>
    <div class="row">
		<div class="col-xs-4">
	...
	<script type="text/javascript">
        ...
        var countdown = new Countdown(span, 60);
        ...
        $(".card").click(function () {
            ...
            // count down time up
            if (_level == 3 && $("#time").html() =="00:00.00") {
                return false;
            }
        ...
        function matchCheck(selectRecordId) {
            ...
            if (select1 == select2) {
                ...
                if (_level == 1) {
                    ...
                    console.log(select1);
                    console.log(select2);
                    $("#card_modal").css("background-image", select1);
                    var ansIndex = $("#card_modal").css("background-image").substr(-8, 2) - 1;
                    $("#lbl_message").html(_answers[ansIndex]);
        ...
        function afterCheck() {
            ...
            if ($("#lbl_message").html() == _answers[ansIndex]) {
