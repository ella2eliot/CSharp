...
namespace SYS.BLL.Domain.Line
{
    ...
    {
        // Logic
        IAccountRegistLogic _AccountRegistLogic { get; set; }
    ...
    internal class LineBotLogic : DataDrivenLogic, ILineBotLogic
    {
        ...
        // Logic
        public IAccountRegistLogic _AccountRegistLogic { get; set; }
        ...
        {
            this._accessToken = "Line access token";
            this._apiKey = "Line api Key";
            ...
            _AccountRegistLogic = CreateLogic<IAccountRegistLogic>();
        ...
        public string EventAZHandel (string postData)
        {
            ...
            try
            {
                        ...
                        CIC.OnMessageTypeCheck += (s, e) =>
                        {
                            switch (e.CurrentPropertyName)
                            {
                                case "EmpId":
                                    ...
                                    var isDF = _chatbotlineWS.GAIAGetEmpByEmpNo(userSays);
                                    if (isDF.EmpNo == null)
                                    {
                                        e.isMismatch = true;
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            var existsAccRegist = _chatbotlineWS.LineGetEmpByEmpNo(userSays);
                                            if (existsAccRegist != null)
                                            {
                                                existsAccRegist.Line_Id = _userId;
                                                existsAccRegist.Emp_no = userSays;
                                                existsAccRegist.Active = false;
                                                _chatbotlineWS.UpdateAcc(existsAccRegist);
                                            }
                                            else
                                            {
                                ...
                                case "Emp_mail":
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            e.isMismatch = true;
                                            e.ResponseMessage = "輸入的信箱與工號不符，請重輸入達方員工信箱";
                                        }
                ...
                {
                    var acc = _chatbotlineWS.LineGetEmpByLineId(_userId);
            ...
            else if (category == 2)
            {
                ...
                switch (processResult.ProcessResultStatus)
                {
                    ...
                    case ProcessResultStatus.Done:
                        ...
                        var emps = _chatbotlineWS.GAIAGetEmpByName(lang, empName);
                        if (emps.Length == 5)
                        {
            ...
            else if (category == 3)
            {
                ...
                switch (processResult.ProcessResultStatus)
                {
                    ...
                    case ProcessResultStatus.Done:
                        ...
                        var acc = _chatbotlineWS.LineGetEmpByEmpNo(empNo);                        
        ...
        {
            var result = false;
            var acc = _AccountRegistLogic.GetAccountByLineId(lineId);
            if (acc != null)
            {
            ...
            try
            {
                ...
                if (lastCode.Message != null)
                {
                    ...
                    else
                    {
                        var acc = _AccountRegistLogic.GetAccountByLineId(lineId);
                        acc.Active = true;
                        _AccountRegistLogic.UpdateAcc(acc);
                    }
                }
