<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1_PictureCode_Check2_DLL.aspx.cs" Inherits="WebApplication2019_Captcha.WebForm.WebForm1_PictureCode_Check2_DLL" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>改用DLL來做（.NET Standard 2.0）</title>
        
    <script type="text/javascript">   
        function reloadcode() {   
            document.getElementById("Image1").src = "ValidatePicture_DLL.ashx?mis2000lab=" + Math.random();   // 改用DLL來做（.NET Standard 2.0）
            return false;
        }
    </script>
    ...
    <script type="text/javascript">           
        ...
        //        this.src = "ValidatePicture_DLL.ashx?mis2000lab=" + Math.random();
...
<body style="background-color:darkseagreen;">
    <h3>改用DLL來做（.NET Standard 2.0） -- 搭配 /WebForm/ValidatePicture_DLL.ashx</h3>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            請輸入圖片驗證碼：<asp:TextBox ID="TextBox3" runat="server" Width="50"></asp:TextBox>
                         ...
                         <asp:Image ID="Image1" runat="server" ImageUrl="ValidatePicture_DLL.ashx"                                                           
                                             onclick="javasrcipt: this.src='/WebForm/ValidatePicture_DLL.ashx?mis2000lab=' + Math.random()" /><br />
            ...
            <asp:Button ID="Button1" runat="server" 
                  Text ="Button_Login 改用DLL來做（.NET Standard 2.0）" OnClick="Button1_Click" />
